declare namespace kontra {
  ...
  function collides(
    obj1: {x: number; y: number; width: number; height: number} | {world: {x: number; y: number; width: number; height: number}},
    obj2: {x: number; y: number; width: number; height: number} | {world: {x: number; y: number; width: number; height: number}}
  ): boolean;
  function getWorldRect(obj: {x: number; y: number; width: number; height: number} | {world: {x: number; y: number; width: number; height: number}} | {mapwidth: number; mapheight: number}): {
    x: number;
    y: number;
    width: number;
    height: number;
  ...
  function onGamepad(
    ...
    callback: (gamepad: Gamepad, button: GamepadButton, buttonName: string) => void,
